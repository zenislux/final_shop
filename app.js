...
initDb.serialize(() => {
  ...
  initDb.run('DROP TABLE IF EXISTS products', () => {
    ...
    initDb.run(`CREATE TABLE products (
      ...
      const fruits = [
        ['싱싱한 사과', '아침에 먹으면 황금 같은 달콤한 국산 사과', 3000, '🍎', 'original/apple.png', 12, 1],
        ['부드러운 바나나', '당도 최고! 든든한 다이어트 친구 필리핀 바나나', 4500, '🍌', 'original/banana.png', 8, 1], // 💡 featured_product에 다 나오게 1로 변경!
        ['상큼한 포도', '한 알씩 쏙쏙 빼먹는 재미가 있는 달달한 캠벨 포도', 7000, '🍇', 'original/grape.png', 15, 1],
        ['새콤달콤 키위', '비타민C가 풍부해 피로 해소에 좋은 뉴질랜드 골드키위', 3500, '🥝', 'original/kiwi.png', 5, 1],
        ['싱그러운 오렌지', '과즙이 팡팡 터지는 고당도 캘리포니아 오렌지', 2500, '🍊', 'original/orange.png', 9, 1],
        ['달콤한 복숭아', '풍부한 과즙과 은은한 향이 일품인 부드러운 백도 복숭아', 5500, '🍑', 'original/peach.png', 21, 1],
        ['시원한 수박', '여름철 더위를 한방에 날려줄 속이 꽉 찬 당도 선별 수박', 18000, '🍉', 'original/watermelon.png', 34, 1]
      ];
